...
def mount_spa(application: FastAPI):
    ...
    """
    # Inject the LIVE module attribute: _apply_ssh_session_token() rebinds
    # web_server._SESSION_TOKEN after mount (Desktop SSH serve path); a by-value
    # import here would keep serving the pre-adoption token the auth middleware
    # rejects — the desktop shell adopts the served token and 401s forever.
