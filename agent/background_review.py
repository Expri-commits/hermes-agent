...
_SKILL_REVIEW_PROMPT = (
    ...
    "or (3).\n\n"
        "Name arguments to skill_manage take the BARE skill name — no category prefix: name='journal', never 'productivity/journal' or 'research:ultimate-browsing'. For SKILL.md omit file_path.\\n\\n"
